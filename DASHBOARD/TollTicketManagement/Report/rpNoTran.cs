...
namespace TollTicketManagement.Report {
    ...
    public class rpNoTran : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "TollTicketManagement.Report.rpNoTran.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedrpNoTran : Component, ICachedReport {
        
        public CachedrpNoTran() {
        }
